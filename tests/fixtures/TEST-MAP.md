...
### adapter 切片 4c（恢复入口+黄项收口；recover.ts 受控 29 it；E2E 10 it 见上（含谓词负例×4）；s4f/s4g/s4h/s4i 补轮：F1/F2/F3+G1/G2+H1/H2+I1 已修）
