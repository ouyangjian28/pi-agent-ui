...
### adapter 切片 4c（恢复入口+黄项收口；recover.ts 受控 21 it；E2E 9 it 见上（含谓词负例×3）；s4f/s4g 补轮：F1/F2/F3+G1/G2 已修）
